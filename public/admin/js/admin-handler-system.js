...
Handler.prototype.system = {};

Admin.FormSpecs.system = {
	title   : 'レベルの追加/編集',
	desc	: 'ずどーーん',
	method  : 'post',
	action  : 'level.save',
...
// レベル一覧表示
Handler.prototype.system.list = function(data) {
...
//レベル設定保存完了
Handler.prototype.system.save = function(data) {
	hideForm();
...
//レベル設定削除完了
Handler.prototype.system.remove = function(data) {
	hideForm();
